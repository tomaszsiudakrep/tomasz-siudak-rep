...
public class BoardTestSuite {
    ...
    void testAddTaskListAverageWorkingOnTask(){
        ...
        Board project = prepareTestData();
        //When
        List<TaskList> inProgressLists = new ArrayList<>();
        inProgressLists.add(new TaskList("In progress"));

        int sumOfDays = project.getTaskLists().stream()
                .filter(inProgressLists::contains)
        ...
        double average = sumOfDays / taskQuantity;
