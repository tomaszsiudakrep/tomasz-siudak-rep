...
@DisplayName("Testy metody listBooksWithCondition(String titleFragment)")
@Nested
...
@DisplayName("Testy metody listBooksInHandsOf(LibraryUser libraryUser)")
@Nested
public class TestListBooksInHandOf{

        @Test
        void testUserHave0Books() {
//Given
            LibraryUser libraryUser = new LibraryUser("Tom", "S", "911145");
            List<Book> listOfBooks = new ArrayList<>();
            when(libraryDatabaseMock.listBooksInHandsOf(any(LibraryUser.class))).thenReturn(listOfBooks);
...
//When
        List<Book> resultList = bookLibrary.listBooksInHandsOf(isA(LibraryUser.class));
//Then
